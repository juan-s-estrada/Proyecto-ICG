...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(screenWidth, screenHeight, "Game Name Here", nullptr, nullptr); // Windowed
	...
	Shader shader("resources/shaders/vert.vert", "resources/shaders/frag.frag");
	//Shader shader2("resources/shaders/vert.vert", "resources/shaders/frag.frag");
	Shader skyboxShader("resources/shaders/shader.vert", "resources/shaders/shader.frag");
...
#pragma region "object_initialization"
	...
	//Load Model
	//Model loadModel("resources/objects/nanosuit/nanosuit.obj");
#pragma endregion
